...
<script>
import CreatePartner from "@back/percursu/partners/Create";
import UpdatePartner from "@back/percursu/partners/Update";
import AppMap from "@pfront/AppMap";
import FeaturedPartners from "@pfront/FeaturedPartners";
